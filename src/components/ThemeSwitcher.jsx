...
const ThemeSwitcher = () => {
  ...
  return (
    <button className={`w-10 h-10 flex justify-center items-center bg-slate-50 rounded-full dark:bg-gray-700 ${theme=== "light"? "[&>*:first-child]:block [&>*:last-child]:hidden" :"[&>*:first-child]:hidden [&>*:last-child]:block"}`} onClick={()=> toggleTheme(themeColor)}>
